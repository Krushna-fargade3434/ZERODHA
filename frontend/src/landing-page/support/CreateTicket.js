       ...
       <div className="container">
            <div className="row p-5 mt-5 mb-5">
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="f"><i class="fa-solid fa-circle-plus"></i>Account Opening</h4>    
                 ...
                 <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="f"><i class="fa-solid fa-chart-column"></i>Your Zerodha Account</h4>    

                    <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Margin/leverage, Product</a><br/>
                 ...
                 <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="f"><i class="fa-sharp fa-solid fa-circle-user"></i>Your Zerodha Account</h4>    
                 ...
                 <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="f"><i class="fa-solid fa-wallet"></i>Funds</h4>    
                 ...
                 <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="f"><i class="fa-solid fa-circle-chevron-down"></i>Console</h4>    
                 ...
                 <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="f"><i class="fa-solid fa-coins"></i>Coin</h4>    
